...
public class IntentIntegrator {
  ...
  private AlertDialog showDownloadDialog() {
    ...
    downloadDialog.setNegativeButton(buttonYes, new DialogInterface.OnClickListener() {
      @Override
    ...
    downloadDialog.setPositiveButton(buttonNo, new DialogInterface.OnClickListener() {
      @Override
      public void onClick(DialogInterface dialogInterface, int i) {}
    });
