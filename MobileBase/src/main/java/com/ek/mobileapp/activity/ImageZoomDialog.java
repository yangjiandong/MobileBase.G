    ...
    private void initView() {
        ...
        btnSave.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                try {
                    String saveImagePath = ((MainApplication) getApplication()).getSaveImagePath();
                    ImageUtils.saveImageToSD(ImageZoomDialog.this, saveImagePath + ImageUtils.getTempFileName()
                            + ".jpg", bitmap, 100);
