...
public class BluetoothDeviceActivity extends AppActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        titleTv.setText("选择蓝牙设备");

        //        AppButton abtnAppButton = new AppButton(BluetoothDeviceActivity.this, getResources().getString(R.string.button_scan)) {
        //            protected void clickAction()
        //            {
        //                doDiscovery();
        //            }
        //            protected com.ek.mobileapp.widget.common.ButtonStyle defaultStyle() {
        //                return getStyleSheet().buttons().bigGreen();
        //            }
        //        };

        //        LinearLayout layout = (LinearLayout) findViewById(R.id.setting_round);
        //        layout.addView(abtnAppButton);
